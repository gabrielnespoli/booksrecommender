...
def load_processed_data():
    return pd.read_csv('data/processed_df.csv', delimiter=',', encoding='utf-8', index_col='ISBN')


def load_books(filename='data/BX-CSV-Dump/BX-Books.csv', columns=['ISBN','Book-Title','Book-Author','Year-Of-Publication']):
